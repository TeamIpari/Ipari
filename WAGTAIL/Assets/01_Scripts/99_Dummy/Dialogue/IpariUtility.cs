...
namespace IPariUtility
{
    ...
    public struct IpariUtility
    {
        ...
        {
            new SFXColorSample{ Color=new Vector3(117f/255f, 106f/255f, 73f/255f), ParamValue=FModParamLabel.PlayerWalkType.Sand, DebugName="흙" }, //흙
            new SFXColorSample{ Color=new Vector3(58f/255f, 95f/255f, 40f/255f), ParamValue=FModParamLabel.PlayerWalkType.Grass, DebugName="풀숲" }, //풀숲
            new SFXColorSample{ Color=new Vector3(208f/255f, 168f/255f, 101f/255f), ParamValue=FModParamLabel.PlayerWalkType.Sand, DebugName="모래" }, //모래
            new SFXColorSample{ Color=new Vector3(121f/255f, 118f/255f, 104f/255f), ParamValue=FModParamLabel.PlayerWalkType.Stone, DebugName="돌" }, //돌
        };
